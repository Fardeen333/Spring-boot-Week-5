package com.codingshuttle.spring_security_app.SpringSecutiryApp.filters;

import com.codingshuttle.spring_security_app.SpringSecutiryApp.config.WebSecurityConfig;
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try {
            ...
            // can do something with response
        } catch (Exception e) {
